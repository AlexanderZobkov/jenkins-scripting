...
image:https://github.com/AlexanderZobkov/jenkins-scripting/actions/workflows/maven.yml/badge.svg["Build Status", link="https://github.com/AlexanderZobkov/jenkins-scripting/actions/workflows/maven.yml"]
